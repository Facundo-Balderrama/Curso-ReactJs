...
const Cart = () => {
    const {cart, removeItem, getCountProducts, getSumProducts, clear} = useContext(CartContext);
            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col text-center">
                        ...
                        <Link to={"/"} className="btn text-white bg-dark my-5 rounded-0">Volver a la Página Principal</Link> 
                    </div>
                </div>
            </div>
        )
            ...
            <div className="row">
                <div className="col">
                    <table className="table">
                        <tbody>
                            <tr>
                                <td colSpan={6} className="text-end"><button to={""} className="btn text-white bg-dark rounded-0" onClick={clear}>Vaciar Carrito</button></td>
                            </tr>
                            {cart.map(item => (
                                <tr key={item.id}>
